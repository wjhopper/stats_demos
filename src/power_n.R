...
ani.pause(.5)
 ...
 }, img.name = "Power_N", imgdir = "Power_N", htmlfile = "Power_N.html", 
    autobrowse = FALSE, title = "Power as a function of N", 
    description = "Power increases as sample size increases")
